...
void weapon::attack(cocos2d::Vec2 position, cocos2d::Vec2 offset)
{
	offset.normalize();
	...
	this->weaponBullet->runAction(cocos2d::Sequence::create(actionMove->clone(), actionRemove, nullptr));
}
...
void rifle::attack(cocos2d::Vec2 position, cocos2d::Vec2 offset)
{
...
void shotGun::attack(cocos2d::Vec2 position,cocos2d::Vec2 offset)
{
	bullet* bullet1 = bullet::create("Projectile.png");
	bullet1->setPosition(position);
	bullet1->setSpeed(2.0f);
